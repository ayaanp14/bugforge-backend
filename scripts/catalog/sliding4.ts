  ...
  (() => {
    ...
    return {
      ...
      solutions: {
        ...
        kotlin: `fun equalSubstring(s: String, t: String, maxCost: Int): Int {\n    var l = 0\n    var cost = 0\n    var best = 0\n    for (r in s.indices) {\n        cost += Math.abs(s[r].code - t[r].code)\n        while (cost > maxCost) {\n            cost -= Math.abs(s[l].code - t[l].code)\n            l++\n        }\n        if (r - l + 1 > best) best = r - l + 1\n    }\n    return best\n}`,
  ...
  (() => {
    ...
    return {
      ...
      solutions: {
        ...
        kotlin: `fun balancedString(s: String): Int {\n    val n = s.length\n    val need = n / 4\n    val cnt = IntArray(128)\n    for (i in 0 until n) cnt[s[i].code]++\n    fun ok(): Boolean =\n        cnt['Q'.code] <= need && cnt['W'.code] <= need && cnt['E'.code] <= need && cnt['R'.code] <= need\n    if (ok()) return 0\n    var best = n\n    var l = 0\n    for (r in 0 until n) {\n        cnt[s[r].code]--\n        while (l <= r && ok()) {\n            if (r - l + 1 < best) best = r - l + 1\n            cnt[s[l].code]++\n            l++\n        }\n    }\n    return best\n}`,
